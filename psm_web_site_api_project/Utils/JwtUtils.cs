...
namespace psm_web_site_api_project.Utils.JwtUtils;
    public static class JwtUtils
    {
        ...
        public static string CreateToken(TokenDto tokenDto)
        {
            ...
            claims.Add(new Claim("iduser", tokenDto.IdUsuario.ToString()));
            claims.Add(new Claim("firstname", tokenDto.Nombres));
            claims.Add(new Claim("lastname", tokenDto.Apellidos));
            claims.Add(new Claim(ClaimTypes.Email, tokenDto.Correo));
